...
/**
 * Bishop one of classes implementing Piece interface. Unlike other pieces, it can only move diagonally.
 *
...
public class Bishop implements Piece {
    ...
    /**
     * Initialize Bishop object. Sets color and position.
    ...
    public ArrayList<Box> getValidMoveBoxes() {
        ...
        for (Box.Direction dir : Box.Direction.values()) {
            if (dir == Box.Direction.D || dir == Box.Direction.U || dir == Box.Direction.L || dir == Box.Direction.R)
                continue;
